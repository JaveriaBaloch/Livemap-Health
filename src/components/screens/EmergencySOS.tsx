          ...
          <>
            ...
            <div className="bg-white border-t border-[#e2e8f0] p-4 flex-shrink-0">
              <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-3">
                <button onClick={() => window.open(`tel:${doctor.phone || "144"}`, "_self")} className="bg-[#10b981] hover:bg-[#059669] text-white py-3.5 px-4 rounded-xl text-sm font-medium transition-colors">📞 Call Doctor</button>
                ...
                <button onClick={() => window.open("tel:144", "_self")} className="bg-[#ef4444] hover:bg-[#dc2626] text-white py-3.5 px-4 rounded-xl text-sm font-medium transition-colors">🚨 Call 144</button>
              </div>
            </div>
          </>
        )}
    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] text-[#1e293b]">
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex justify-center gap-3"><button onClick={cancel} className="bg-[#f1f5f9] hover:bg-[#e2e8f0] text-[#475569] py-3 px-6 rounded-xl text-sm transition-colors">Cancel</button><button onClick={() => window.open("tel:144", "_self")} className="bg-[#ef4444] hover:bg-[#dc2626] text-white py-3 px-6 rounded-xl text-sm font-medium transition-colors">📞 Call 144</button></div>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#f8fafc] text-[#1e293b]">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8"><div className="bg-white rounded-2xl p-8 border border-[#e2e8f0] shadow-sm">
        ...
        <div className="space-y-5"><div><label className="block text-sm text-[#475569] mb-2">Describe emergency (optional)</label><textarea value={msg} onChange={(e) => setMsg(e.target.value)} placeholder="Chest pain, difficulty breathing…" className="w-full bg-[#f1f5f9] border border-[#e2e8f0] rounded-xl px-4 py-3 text-[#1e293b] placeholder:text-[#94a3b8] focus:outline-none focus:border-[#ef4444] transition-colors" rows={4} /></div>
          ...
          <button onClick={() => window.open("tel:144", "_self")} className="w-full bg-[#f1f5f9] hover:bg-[#e2e8f0] text-[#475569] py-3 rounded-xl text-sm transition-colors">📞 Or Call Emergency Services</button>
        </div>
      </div></div>
    </div>
  );
